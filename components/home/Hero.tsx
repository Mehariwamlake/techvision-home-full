  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Launch Your{" "}
          <span className="bg-gradient-to-r from-[#2DB266] via-[#69FF99] to-[#B2FF59] bg-clip-text text-transparent">
            Tech Career
          </span>
        </motion.h1>
        ...
        <motion.p
          variants={itemVariants}
          className="mt-8 max-w-2xl text-lg leading-relaxed text-[#9FB3A8] md:text-xl uppercase"
        >
