...
export function Faq() {
  ...
  return (
    <section
      id="faq"
      ref={ref}
      className="bg-[#050B08] py-20 px-6 relative overflow-hidden section-bridge-top"
    >
      <motion.div style={{ y }} className="max-w-2xl mx-auto relative z-10">
        ...
        >
          <div className="text-[#FFFFFF] text-[14px] font-medium tracking-[0.25em] uppercase mb-4">
            FAQ
          </div>
        ...
        <div className="space-y-3">
          {faqs.map((faq, i) => (
            ...
            >
              ...
              >
                <span
                  className={`font-bold text-sm sm:text-base transition-colors duration-300 ${open === i ? "text-[#00C853]" : "text-white"}`}
                >
                  {faq.q}
                </span>
                <motion.div
